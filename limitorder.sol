...
import "./contracts/UniswapUtils.sol";
...
contract Limit_order is UniswapUtils,Ownable,ERC721Upgradeable {
    ...
    function placeLimitOrder(LimitOrderParams calldata params) public payable virtual override returns (uint256 _tokenId) {
        ...
        (_tickLower, _tickUpper, _liquidity, _orderType) = UniswapUtils.calculateLimitTicks( // TODO: verify this
                _pool,
